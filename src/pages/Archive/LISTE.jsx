            ...
            <Card className="mb-4">
                ...
                <Card.Body>
                    <Row className="g-3 mb-3">
                        ...
                        <Col md={3}>
                            <Form.Label>Nom d'Avocat</Form.Label>
                            <Form.Control
                                type="text"
                                name="nom_avo"
                                placeholder="Nom d'Avocat"
                                value={filters.nom_avo}
                                onChange={handleFilterChange}
                            />
                        </Col>
                        <Col md={3}>
                            <Form.Label>Prenom d'Avocat</Form.Label>
                            <Form.Control
                                type="text"
                                name="prenom_avo"
                                placeholder="Prénom d'Avocat"
                                value={filters.prenom_avo}
                                onChange={handleFilterChange}
                            />
                        </Col>
                    </Row>
